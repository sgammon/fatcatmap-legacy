...
def addsitepackages(known_paths):
    ...
    buildout_paths = [
        join(base, 'eggs\\babel-0.9.6-py2.7.egg'),
        join(base, 'eggs\\slimmer-0.1.30-py2.7.egg'),
        join(base, 'eggs\\gaepytz-2011h-py2.7.egg'),
        join(base, 'eggs\\wtforms-1.0.1-py2.7.egg'),
        join(base, 'eggs\\logbook-0.3-py2.7-win32.egg')
        ]
