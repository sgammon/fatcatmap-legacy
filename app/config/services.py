...
config['apptools.project.services'] = {
    ...
    'config': {
        ...
        'secret_key': 'vncovnb)(*!#N(*#g918b9cv8h109h2vxvbIUb7182bSKJHD(!@*',  # Secret key for generating HMAC signings
    ...
    'services': {
        ...
        ## Graph API - serves graph structure for building graph visualizations
        'graph': {
            'enabled': True,
            'service': 'fatcatmap.services.graph.GraphService',
            'methods': ['traverseNode', 'buildFromNode', 'navigate'],
        ...
        ## Realtime API - serves data, search results, and share notifications to clients
        'realtime': {
            'enabled': True,
            'service': 'fatcatmap.services.realtime.RealtimeService',
            'methods': ['establish', 'data', 'search', 'share'],
        ...
        ## Frame API - serves raw or rendered templates
        'frame': {
            'enabled': True,
            'service': 'fatcatmap.services.frame.FrameService',
        ...
        'politician': {
            'enabled': True,
            'service': 'fatcatmap.services.data.politician.PoliticianService',
            'methods': ['get', 'list'],
        ...
        'committee': {
            'enabled': True,
            'service': 'fatcatmap.services.data.committee.CommitteeService',
            'methods': ['get', 'list'],
        ...
        'legislation': {
            'enabled': True,
            'service': 'fatcatmap.services.data.legislation.LegislationService',
            'methods': ['get_bill', 'get_fulltext', 'get_analysis', 'get_objects'],
