...
def run(environment):
    ...
    def block_page_services(context, environment=environment):
        ...
        if environment.getattr(l_page, 'services'):
            ...
            if l_build_page_object is missing:
                l_build_page_object = environment.undefined("the template %r (imported on line 18 in '/source\\\\core\\\\__south.html') does not export the requested name 'build_page_object'" % included_template.__name__, name='build_page_object')
            yield u'\n'
    ...
    debug_info = '2=11&5=12&6=13&7=14&11=15&14=17&16=20&23=23&16=27&17=31&18=33&19=38&23=40&24=44&25=46&26=51'
    return locals()